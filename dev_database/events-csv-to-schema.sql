insert into pd_wbgtravel.people(short_name,organization,image_file,is_wbg)
select distinct 
"Person" as full_name,
...
insert into pd_wbgtravel.cities(city_name,country_name,latitude,longitude)
select distinct 
...
de."Visit start",
de."Visit end",
de."Event" as trip_reason
FROM pd_wbgtravel.dev_events de
inner join pd_wbgtravel.people pe on pe.short_name = de."Person" or pe.short_name = de."Counterpart"
